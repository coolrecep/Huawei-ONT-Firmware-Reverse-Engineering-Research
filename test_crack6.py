...
chan.send("cp /mnt/jffs2/hw_ctree.xml /tmp/hw_ctree.xml\n")
recv_until(chan, "# ", timeout=5)

# Try running from tmp dir? Maybe aescrypt tries to create temp files in the current dir?
chan.send("cd /tmp\n")
recv_until(chan, "# ", timeout=5)

chan.send("/bin/aescrypt2 1 /tmp/hw_ctree.xml /tmp/hw_ctree.decrypted.xml\n")
