...
# /var is mounted as tmpfs with EXEC permissions (no noexec flag)!
# Let's run decrypt_test from /var!

chan.send("cp /tmp/decrypt_test /var/decrypt_test\n")
recv_until(chan, "# ", timeout=5)

chan.send("chmod +x /var/decrypt_test\n")
recv_until(chan, "# ", timeout=5)

chan.send("/var/decrypt_test\n")
