...
# Check if opmaintain exists in filesystem
chan.send("ls -la /opt/upt/apps/apps/opt/apps/opmaintain/diagapps/ommonitord\n")
out = recv_until(chan, "# ", timeout=5)
print(out)

chan.send("find / -name opmaintain 2>/dev/null\n")
