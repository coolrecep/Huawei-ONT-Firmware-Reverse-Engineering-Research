...
# Wait, aescrypt2 has permissions: -r-xr-x--- 1 srv_ssmp service
# Our shell is likely running as srv_clid, NOT srv_ssmp!
# So we cannot even execute aescrypt2.

chan.send("id\n")
out = recv_until(chan, "# ", timeout=5)
print(out)

chan.send("ls -la /bin/aescrypt2\n")
out = recv_until(chan, "# ", timeout=5)
print(out)
